...
import com.akram.livres.security.KeycloakRoleConverter;
...
public class SecurityConfig {
	...
	@Autowired
	KeycloakRoleConverter keycloak_role_converter;
		...
		.cors(cors -> cors.configurationSource(new CorsConfigurationSource() {
	     ...
	     .authorizeHttpRequests( requests -> requests
						...
						.anyRequest().authenticated() )
	     				...
	     				.oauth2ResourceServer(ors->ors.jwt(jwt->jwt.jwtAuthenticationConverter(keycloak_role_converter)));
